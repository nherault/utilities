...
function enableSmartTab(inputElement) {
    if (!inputElement) {
...
exports.enableSmartTab = enableSmartTab;
function disabledSmartTab(inputElement) {
    inputElement.removeEventListener('keydown', tabKeydownListener);
}
exports.disabledSmartTab = disabledSmartTab;
;
